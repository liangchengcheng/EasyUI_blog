...
<form action="${pageContext.request.contextPath}/blogger/login.do"
    ...
    border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
        ...
        <DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
            <P style="margin: 0px 35px 20px 45px;">
                ...
                <SPAN style="float: right;">
						...
						color: rgb(255, 255, 255); font-weight: bold;" value="登录"/>
				</SPAN>
            </P>
        </DIV>
    </DIV>
